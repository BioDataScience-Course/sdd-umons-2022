...
```{r}
(biometry_marvel <- as_dtt(tribble(
...
```{r}
(biometry_marvel1 <- as_dtt(tribble(
  ~id,     ~sex , ~weight, ~height,
   "24_1",  "M",  95,      1.91,
   "24_2",  "M",  80,      1.79,
   "24_3",  "M",  82,      1.93,
