...
Cette section détaillera l'ensemble des notions que vous allez apprendre à maîtriser durant ce tutoriel. Par exmple, pour le premier tutoriel, l'objectif est de découvrir comment fonctionne un learnr à l'aide de différentes questions de culture générale.
