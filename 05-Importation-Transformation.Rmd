...
urchin2[1:6, ] # Rcupèrer les 6 premières lignes de urchin2 et l'imprime = head()
```
...
Notez que vous pouvez utilise l'assignation alternative à peu pr!ès n'importe quand, et même aussi avec les fonctions speedy.
