...
<!-- PhG: ici j'ai un problème car le `group_by()` me crée un grouped_df, tbl_df, tbl, data.frame. Donc, mon data.table a été converti en un tibble qui est surcalssé (et mon code ne rétabli pas le bon format en cas de surclassement) ! -->
