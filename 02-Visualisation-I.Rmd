...
*Note : pour rappel, le travail ci-dessous est un **projet GitHub Classroom**. Créez le dépôt GitHub en cliquant sur le lien. Ensuite, clonez-le dans votre machine virtuelle et vous aurez un nouveau projet RStudio* \@ref(rs-projet) *dans lequel vous pourrez travailler. Les instructions sont indiquées dans le fichier `README.md` à la racine de ce projet.*
